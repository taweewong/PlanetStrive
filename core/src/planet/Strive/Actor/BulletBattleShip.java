...
public class BulletBattleShip extends Actor{
    public static final int SPEED = 500;
    private Texture texture = new Texture(Gdx.files.internal("blue mother laser.png"));
    private EnemyRanger enemy ;
    private SpaceRanger ranger;
    ...
    public BulletBattleShip(SpaceRanger ranger, EnemyRanger enemy, float rotate, int damage) {
        this.enemy = enemy;
        this.ranger = ranger;
        this.rotate = rotate;
