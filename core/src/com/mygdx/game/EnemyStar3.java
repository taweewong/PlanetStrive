 ...
 */
public class EnemyStar3 extends SpaceRanger{
    private Texture texture = new Texture("Dagawa.png");
    ...
    public EnemyStar3() {
        ...
        starblue.setPosition(10482+105, 100+105);
        ...
        orbit = new Sprite(new Texture("dagawa-1.png"));
        orbit.setPosition(10474, 90);
